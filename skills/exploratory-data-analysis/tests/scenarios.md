...
**Status: behavior scenarios below are authored only — no behavior arm has run, and nothing below is a result.**
The shipped description's measured gain and cost arms are `tests/runs/artifacts/2026-08-15-widening/BvC-gates.md`, governed by that wave's own preregistration, not by this file. `[measured: skill=exploratory-data-analysis state=current evidence=eda-widening-2026-08-15-bvc-c3]`
Its measured seam arms are `tests/runs/artifacts/2026-08-15-widening/seam-gate4.md`, under the same preregistration. `[measured: skill=exploratory-data-analysis state=current evidence=eda-widening-2026-08-15-seam]`
The 2026-08-11 trigger arms (`tests/runs/2026-08-11-t13-trigger.md`, `tests/runs/2026-08-11-t14-trigger.md`) measured the pre-C3 description under their own preregistration, also not governed by this file. `[measured: skill=exploratory-data-analysis state=historical evidence=eda-trigger-2026-08-11]`
