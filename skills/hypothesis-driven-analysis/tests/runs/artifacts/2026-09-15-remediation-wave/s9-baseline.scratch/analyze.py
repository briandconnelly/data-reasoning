...
print(f"n days = {n}")
print(
    f"mean daily diff (B-A) = {mean_d * 100:.2f} pp, sd = {sd_d * 100:.2f} pp, se = {se_d * 100:.2f} pp"
)
print(
    f"paired t-stat = {t_stat:.3f} (approx df={n - 1}, compare to t-crit ~2.16 for df=13, alpha=0.05 two-sided)"
)
