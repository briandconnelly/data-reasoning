...
Fee is $30 and delay and other costs are $0 (provenance: user-elicited), so C=$30.
Net value is G−C=30−30=$0.
...
Buying at $30 and deciding without the report have equal expected total loss of $50.

- Cost: $30 total, consisting of $30 fee plus $0 delay and $0 other costs (provenance: user-elicited).
- Verdict: not-worth-it

Source: `/private/tmp/voi-pricing-control/prompts.json`, case `equality`.
